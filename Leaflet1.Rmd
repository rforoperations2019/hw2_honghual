...
leaflet() %>%
  ...
  #Adding polyong to show boundary and pop up to show names of properties
  addPolygons(data = realestate, popup = ~NAME, color = "blue", group = c("Toner","Terrain", "Toner Lite"))
